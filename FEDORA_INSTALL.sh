...
if [ ! -f setup_fedora.sh               -o \
  ...
  echo "USAGE: $0 missing files [versions.sh setup_fedora.sh, install_npm_packages.sh, DATANET_CENTRAL_INSTALL.sh, DATANET_OPEN_RESTY_INSTALL.sh, print_example_usage.sh]"
  exit 2;
fi
