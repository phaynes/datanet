-- NOTE: TAKEN FROM GITHUB REPO: https://github.com/pintsized/lua-resty-http
--       NEXT LINE MODIFIED BY RUSSELL SULLIVAN 5/17/2016
--local http_headers = require "resty.http_headers"
local http_headers = require "datanet.http_headers"
...
function _M.send_request(self, params)
    ...
    if not headers["Host"] then
        if (string.sub(self.host,1,5) == "unix:") then
